...
class _GroupDetailView extends StatelessWidget {
  ...
  void _confirmDelete(BuildContext ctx, String groupName) {
    showDialog(
      context: ctx,
      builder: (dCtx) => AlertDialog(
        title: const Text('Delete Group'),
        content: Text('Delete "$groupName"? This cannot be undone.'),
        actions: [
          TextButton(
              ...
              actions: [
                ...
                PopupMenuButton<String>(
                  onSelected: (v) {
                    ...
                    if (v == 'delete') {
                      _confirmDelete(ctx, group?.name ?? 'this group');
                    }
                  },
                  itemBuilder: (_) => const [
